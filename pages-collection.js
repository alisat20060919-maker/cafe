...
function renderStyle() {
  return `<style>
    #page-collection{--book:#fff7df;--paper:#fffdf4;--ink:#5f3c21;--line:rgba(96,58,24,.2);height:100%;padding:8px 10px 86px;color:var(--ink);overflow:hidden}
    #page-collection .album-shell{height:100%;max-height:calc(100dvh - 170px);border-radius:24px;background:linear-gradient(180deg,#e8c78e,#9f6d37 52%,#73451f);padding:9px;box-shadow:inset 0 0 0 2px rgba(255,244,206,.45),0 14px 30px rgba(55,31,15,.22);overflow:hidden}
    ...
    #page-collection .album-title h2{margin:0;font-size:1rem;letter-spacing:.04em}.album-title b{font-size:.72rem;opacity:.68}.album-tabs{display:flex;gap:0;padding:0 8px;border-bottom:1px solid rgba(92,56,24,.14);overflow-x:auto;overflow-y:hidden;background:rgba(99,65,31,.08)}
