...
function renderStyle() {
  return `<style>
    #page-collection{--book:#fff7df;--paper:#fffdf4;--ink:#5f3c21;--line:rgba(96,58,24,.2);height:calc(100dvh - 86px);padding:8px 10px 0;color:var(--ink);overflow:hidden;touch-action:none}
    ...
    #page-collection .album-page{height:100%;display:flex;flex-direction:column;border-radius:19px;background:radial-gradient(circle at 50% 6%,rgba(255,255,255,.8),transparent 34%),linear-gradient(180deg,#fffdf2,#f3e1bb);box-shadow:inset 0 0 32px rgba(92,56,24,.16);border:1px solid rgba(92,56,24,.2);overflow:hidden}
    #page-collection .album-title{flex:0 0 auto;display:flex;justify-content:space-between;align-items:center;padding:10px 13px 7px;border-bottom:1px solid rgba(92,56,24,.12)}
    #page-collection .album-title h2{margin:0;font-size:1rem;letter-spacing:.04em}.album-title b{font-size:.72rem;opacity:.68}.album-tabs{flex:0 0 auto;display:flex;gap:0;padding:0 8px;border-bottom:1px solid rgba(92,56,24,.14);overflow-x:auto;overflow-y:hidden;background:rgba(99,65,31,.08);-webkit-overflow-scrolling:touch;touch-action:pan-x}
