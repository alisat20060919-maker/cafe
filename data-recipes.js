export const recipes = {
  recipe_moon_latte: {
    ...
    station: 'kitchen',
    category: 'drink',
    unlockRequirement: { level: 1, station: 'kitchen' },
  ...
  recipe_dream_cocoa: {
    ...
    station: 'kitchen',
    category: 'drink',
    unlockRequirement: { level: 2, station: 'kitchen' },
  ...
  recipe_moon_dew: {
    ...
    unlockRequirement: { level: 2, station: 'alchemy' },
    cost: { moon_petals: 1, stardew_water: 1 },
  ...
  recipe_pure_moon_essence: {
    ...
    station: 'alchemy',
    category: 'refined_material',
    unlockRequirement: { level: 3, station: 'alchemy' },
